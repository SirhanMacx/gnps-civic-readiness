    ...
    <fieldset class="border border-border rounded-lg p-5">
      ...
      <div class="space-y-4">
        <label class="block">
          ...
          <textarea name="researchQuestion" rows="3" minlength="30" maxlength="2000" required class="w-full mt-1 px-3 py-2 border border-border rounded text-sm focus:border-primary focus:ring-1 focus:ring-primary"></textarea>
